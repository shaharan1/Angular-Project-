...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'radiology',
        loadComponent: () => import('./features/radiology/radiology-dashboard.component').then(m => m.RadiologyDashboardComponent)
      },
      {
        path: 'wards',
        loadComponent: () => import('./pages/wards/ward-management').then(m => m.WardManagement)
      },
      {
        path: 'settings',
